  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-16 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl sm:text-2xl text-gray-600 mb-8 animate-fade-up max-w-2xl mx-auto" style={{ animationDelay: "200ms" }}>
          Building and breaking secure applications to make them more secure
        </p>
